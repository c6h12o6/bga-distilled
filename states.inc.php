...
$machinestates = array(
    ...
    20 => array(
        ...
        "type" => "activeplayer",
        "args" => "argDistill",
        "description" => clienttranslate('${actplayer} must select cards from pantry to distill a spirit or pass'),
        "descriptionmyturn" => clienttranslate('${you} must select cards from pantry to distill a spirit or pass'),
