...
$miscTranslate = array(
  ...
  clienttranslate("2 from same region = 2"),  
  clienttranslate("3 from same region = 4"),  
  clienttranslate("4 from same region = 7"),  
  clienttranslate("5 from same region = 10"), 
  clienttranslate("6+ from same region = 15"),
  clienttranslate("3 different regions = 5"),
  clienttranslate("BARREL"),
